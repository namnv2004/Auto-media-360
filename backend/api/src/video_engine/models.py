...
class VideoJob(Base):
    ...
    full_script = Column(Text, nullable=True)  # Store the full rewritten script (Hook, Body, CTA)
...
class ScriptSegment(Base):
    ...
    keyword = Column(String(255), nullable=True)  # Matched keyword for image search
